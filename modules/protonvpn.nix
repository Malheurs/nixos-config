    ...
    services.protonvpn = {
      ...
      interface = {
        name = mkOption {
          ...
          example = "protonvpn";
          type = types.str;
          description = "The name of the Wireguard network interface to create.";
        };
        ip = mkOption {
          default = "10.2.0.2/32";
          example = "10.2.0.2/32";
        ...
        privateKeyFile = mkOption {
          ...
          type = types.path;
          description = "The path to a file containing the private key for this interface/peer. Only root should have access to the file.";
        };
        dns = {
          enable = mkOption {
            default = true;
          ...
          ip = mkOption {
            ...
            example = "10.2.0.1";
            type = types.str;
            description = "The IP address of the DNS provided by the VPN.";
          };
        };
      };
      endpoint = {
        publicKey = mkOption {
          default = "WeqHIUm2kUqZVMcr+6r5qxgM1FT9N/s/BAbEBPF/O0Q=";
          example = "23*********************************************=";
          type = types.str;
          description = "The public key of the VPN endpoint (IT#42 server).";
        };
        ip = mkOption {
          default = "146.70.182.2";
          example = "48.1.3.4";
          type = types.str;
        ...
        port = mkOption {
          ...
          example = 51820;
          type = types.port;
          description = "The port number of the VPN peer endpoint.";
        };
      };
      # Options spécifiques ProtonVPN
      portForwarding = {
        enable = mkOption {
          default = true;
          type = types.bool;
          description = "Enable NAT-PMP port forwarding for torrents";
        };
      };
    };
  };
    ...
    networking.wg-quick.interfaces."${cfg.interface.name}" = {
      ...
      peers = [
        { 
          ...
          persistentKeepalive = 25;  # Garde la connexion active
        }
      ];
    };